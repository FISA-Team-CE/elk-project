...
## 선정 주제
### 🎯 주제 2
> 회원 등급에 따른 소비를 분석 후, 각 등급에서 소비가 집중된 종목 확인  
> 디지털 채널 사용에 있어 4060세대의 가입여부를 확인하고 **학원비**에 따른 소비 분석
...
#### 1-1. 회원 등급 중 높은 등급인 VVIP와 VIP에 따른 종목별 카드 사용 차트
...
#### 1-2. 회원 등급이 낮은 등급인 골드와 해당없음에 따른 종목별 카드 사용 차트
...
#### 2-1. 디지털 채널 이용 여부에 따른 카드 총 소비량 비교 차트
...
#### 2-2. 높은 회원등급에 속하는 4060세대 회원의 학원비 소비 차트
...
#### 3. 회원 등급과 연령대가 높은 회원들의 특정 소비 비교 차트 
...
## 선정 주제
### 🎯 주제 3
> 거주지역과 소비지역이 다른 소비자들에 대한 가설을 수립
> 장기 가입자 중 이용 금액이 낮은 사용자 분석
